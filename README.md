...
## Introduction
This code is the Pytorch implementation of RNM is forked from [tgc1997](https://github.com/tgc1997/RMN) and the data Hindi MSR-VTT dataset is created by [alokssingh](https://github.com/alokssingh)
## Dependencies
